...
double ieee754_log(double x) {
    ...
    static const number
            ...
            a2 = {{0x0001aa8f, 0xbfe00000}},
            a3 = {{0x55588d2e, 0x3fd55555}},

            b0 = {{0x55555555, 0x3fd55555}},
            b1 = {{0xffffffbb, 0xbfcfffff}},
            b2 = {{0x9999992f, 0x3fc99999}},
            b3 = {{0x556503fd, 0xbfc55555}},
            b4 = {{0x925b3d62, 0x3fc24924}},
            b5 = {{0x160472fc, 0xbfbffffe}},
            b6 = {{0x25db58ac, 0x3fbc71c5}},
            b7 = {{0x11a2a61c, 0xbfb9a4ac}},
            b8 = {{0x0df2b591, 0x3fb75077}},

            sqrt_2 = {{0x667f3bcc, 0x3ff6a09e}},
            h1 = {{0x00000000, 0x3fd2e000}},
            h2 = {{0x00000000, 0x3f669000}},
            delu = {{0x00000000, 0x3f700000}},
            delv = {{0x00000000, 0x3ef00000}},
            ln2a = {{0xfefa3800, 0x3fe62e42}},
            ln2b = {{0x93c76730, 0x3d2ef357}},
            two54 = {{0x00000000, 0x43500000}},
            u03 = {{0xeb851eb8, 0x3f9eb851}};
    ...
    w = x - 1;
    if (__builtin_expect((fabs(w) > u03.d), 1))
        goto case_03;
    ...
    t5 = (w) - t4;
    a = (t8) * (w);
    aa = (((t2 * t4 - a) + t2 * t5) + t3 * t4) + t3 * t5;;
    b = (w) + (a);
    bb = (fabs(w) > fabs(a)) ? (((w) - (b)) + (a)) : (((a) - (b)) + (w));;
    ...
    n += (num.i[1] >> 20) - 1023;
    num.i[1] = (num.i[1] & 0x000fffff) | 0x3ff00000;
    if (num.d > sqrt_2.d) {
        num.d *= 0x1.0p-1;
        n++;
    }
    ...
    num.d += h1.d;
    i = (num.i[1] & 0x000fffff) >> 12;


    num.d = u * Iu[i].d + h2.d;
    j = (num.i[1] & 0x000fffff) >> 4;


    p0 = (1 + (i - 75) * delu.d) * (1 + (j - 180) * delv.d);
    q = u - p0;
    r0 = Iu[i].d * Iv[j].d;
    w = q * r0;
    ...
    lvbj = Lv[j][1].d;
    sij = (luai) + (lvaj);
    ssij = (fabs(luai) > fabs(lvaj)) ? (((luai) - (sij)) + (lvaj)) : (((lvaj) - (sij)) + (luai));;
    A = (nln2a) + (sij);
    ttij = (fabs(nln2a) > fabs(sij)) ? (((nln2a) - (A)) + (sij)) : (((sij) - (A)) + (nln2a));;
    B0 = (((lubi + lvbj) + ssij) + ttij) + dbl_n * ln2b.d;
    B = polI + B0;
